...
class Customization{
    ...
    public function set()
    {
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('POST')->setService('customization')->send($this->buildRequestBody());
    }

    public function get()
    {
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('GET')->setService('customization')->send();
    }

    public function delete()
    {
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('DELETE')->setService('customization')->send();
    }
}
