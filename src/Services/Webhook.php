...
class Webhook{
    ...
    public function create(?string $callbackUrl = null)
    {
        ...
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('POST')->setService('webhook')->send($parameters);
    }

    public function get()
    {
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('GET')->setService('webhook')->send();
    }

    public function getById(?string $id = null)
    {
        $path_parameters = [$id];
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('GET')->setService('webhook')->send([], $path_parameters);
    }
    ...
    public function update(?string $id = null, ?string $callbackUrl = null)
    {
        ...
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('PUT')->setService('webhook')->send($parameters, $path_parameters);
    }

    public function delete(?string $id = null)
    {
        $path_parameters = [$id];
        return \Innovativesprouts\MayaPayment\Facades\MayaClient::setRequestMethod('DELETE')->setService('webhook')->send([], $path_parameters);
    }
}
